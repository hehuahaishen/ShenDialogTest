...
public class DrawErrorView extends View {
    ...
    public DrawErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DrawErrorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.red));  // 设置画笔颜色
    ...
    private class DrawLineLeft extends AnimatorTemplet {
        ...
        public DrawLineLeft() {
            ...
            // 就是不断的获取大圆的角度
            // 从0-2π
            valueAnimatorLeft = ValueAnimator.ofFloat(0, radius/2);            // 变化范围 -- 设置开始值和结束值
        ...
        float start_x = mPaintSize + radius/4*3;
        float start_y = mPaintSize + radius/4*3;
        @Override
        void drawLineLeft(Canvas canvas) {
    ...
    private class DrawLineRight extends AnimatorTemplet {
        ...
        public DrawLineRight() {
            ...
            // 就是不断的获取大圆的角度
            // 从0-2π
            valueAnimatorRight = ValueAnimator.ofFloat(0, radius/2);            // 变化范围 -- 设置开始值和结束值
        ...
        float start_x = mPaintSize + radius/4*5;
        float start_y = mPaintSize + radius/4*3;
        @Override
        void drawLineRight(Canvas canvas) {
            canvas.drawLine(start_x, start_y,
